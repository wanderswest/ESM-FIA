...
F2$TEMP5growchg[F2$TEMP5growchg==0] <- rnorm(sum(F2$TEMP5growchg==0),0,sd=0.05) #make median 0 value a distribution for subseting
...
F33 <- subset(F33, aPREVSTOCKDIAbinlength> 10) #Null model needs at least 25 comparison plots at each diameter/stocking bin
...
#calc y-axis error
R2 <- 10 #1000 bootstrap repetitions; set to 10 for faster looping
...
P1 <- ggplot(F7, aes(x=x3, y=(y3+y3start1), fill=as.factor(col3)))  +geom_hline(y=y3start1, linetype=3) +geom_vline(linetype=3)+ geom_errorbar(limits, width=0.01, colour="grey50") + geom_point(colour="grey25", size=2.5, pch=21)  + theme(axis.line = element_line( size = 0.35)) + theme(axis.ticks.margin = unit(0.06, "cm")) + theme(axis.ticks.length = unit(0.1, "cm")) + theme(plot.margin=unit(c(0,0,0,0), "cm")) +theme( panel.background = element_rect(fill=NA),  panel.grid.major = element_blank(),panel.grid.minor = element_blank(), plot.background = element_rect(fill=NA))  + theme(axis.text.y = element_text(angle = 90, hjust = 0.5, size=11, colour="black"))+ theme(axis.text.x = element_blank())+ scale_y_continuous(name=expression(paste("Productivity (Mg C ha"^"-1","yr" ^"-1",")")), limits=c(Cymin, Cymax)+y3start1, breaks=c(round(y3start1, 2)-0.5, round(y3start1, 2), round(y3start1, 2)+0.5), labels=c(round(y3start1, 2)-0.5, round(y3start1, 2), round(y3start1, 2)+0.5)) + scale_x_continuous(element_blank(), breaks=c(-0.5, 0, 0.5))+ theme(legend.title=element_blank(), legend.key=element_rect(fill="white"), legend.key.size = unit(0.35, "cm"), legend.position = c(0.5,0.9),plot.margin=unit(c(0,0,0,0), "cm")) +scale_fill_manual( name=NULL, breaks=c("1", "3"), label=c( "Dry 5-yr period", "Wet 5-yr period"), values=c(col4)) 
...
#NPP plot
limits <- aes(ymax=(y3+errory3)+y3start1, ymin=(y3-errory3+y3start1))
T1 <- ggplot(F8, aes(x=x3, y=(y3+y3start1), fill=as.factor(col3)))  +geom_hline(y=y3start1, linetype=3)+geom_vline(linetype=3)+ geom_errorbar(limits, width=0.01, colour="grey50")+ geom_point(colour="grey25", size=2.5, pch=21) +theme(axis.line = element_line( size = 0.35)) + theme(axis.ticks.margin = unit(0.06, "cm")) + theme(axis.ticks.length = unit(0.1, "cm")) + theme(legend.position = "none",plot.margin=unit(c(0,0,0,0), "cm")) +theme( panel.background = element_rect(fill=NA),  panel.grid.major = element_blank(),panel.grid.minor = element_blank(), plot.background = element_rect(fill=NA)) + theme(axis.text.y = element_blank())+ theme(axis.text.x =element_blank())+ scale_y_continuous(element_blank(), limits=c(Cymin, Cymax)+y3start1, breaks=c(round(y3start1, 2)-0.5, round(y3start1, 2), round(y3start1, 2)+0.5)) + scale_x_continuous(element_blank(),breaks=c(-0.5, 0, 0.5, 1.0))+ theme(legend.title=element_blank(), legend.key=element_rect(fill="white"), legend.key.size = unit(0.35, "cm"), legend.position = c(0.5,0.9),plot.margin=unit(c(0,0,0,0), "cm")) +scale_fill_manual( name=NULL, breaks=c("1", "3"), label=c("Cool 5-yr period", "Warm 5-yr period"), values=c(col8))
...
limits <- aes(ymax=(y3+errory3)+y3start1, ymin=(y3-errory3+y3start1))
#NPP plot
R1 <- ggplot(F9,aes(x=x3, y=(y3+y3start1), fill=as.factor(col3))) +geom_hline(y=y3start1, linetype=3) +geom_vline(linetype=3)+ geom_errorbar(limits, width=0.02, colour="grey50")+ geom_point(colour="grey25", size=2.5, pch=21) +theme(axis.line = element_line( size = 0.35)) + theme(axis.ticks.margin = unit(0.06, "cm")) + theme(axis.ticks.length = unit(0.1, "cm")) + theme(legend.position = "none",plot.margin=unit(c(0,0,0,0), "cm")) +theme( panel.background = element_rect(fill=NA),  panel.grid.major = element_blank(),panel.grid.minor = element_blank(), plot.background = element_rect(fill=NA)) + theme(axis.text.y = element_blank())+ theme(axis.text.x =(element_blank())) + scale_y_continuous(element_blank(), limits=c(Cymin, Cymax)+y3start1, breaks=c(round(y3start1, 2)-0.5, round(y3start1, 2), round(y3start1, 2)+0.5)) + scale_x_continuous(element_blank()) + theme(legend.title=element_blank(), legend.key=element_rect(fill="white"), legend.key.size = unit(0.35, "cm"), legend.position = c(0.5,0.9),plot.margin=unit(c(0,0,0,0), "cm")) +scale_fill_manual( name=NULL, breaks=c("1", "3"), label=c( "Dry summer", "Wet summer"), values=c(col9))
...
limits <- aes(ymax=(y3+errory3)+y3start1, ymin=(y3-errory3+y3start1))
P1 <- ggplot(F7, aes(x=x3, y=(y3+y3start1), fill=as.factor(col3)))  +geom_hline(y=y3start1, linetype=3) +geom_vline(linetype=3)+ geom_errorbar(limits, width=0.01, colour="grey30") + geom_point(colour="grey25", size=2.5, pch=21)  + theme(axis.line = element_line( size = 0.35)) + theme(axis.ticks.margin = unit(0.06, "cm")) + theme(axis.ticks.length = unit(0.1, "cm")) + theme(plot.margin=unit(c(0,0,0,0), "cm")) +theme( panel.background = element_rect(fill=NA),  panel.grid.major = element_blank(),panel.grid.minor = element_blank(), plot.background = element_rect(fill=NA))  + theme(axis.text.y = element_text(angle = 90, hjust = 0.5, size=11, colour="black"))+ theme(axis.text.x = element_text( hjust = 0.5, size=11, colour="black")) + scale_y_continuous(name=expression(paste("Productivity (Mg C ha"^"-1","yr" ^"-1",")")), limits=c(Cymin, Cymax)+y3start1,breaks=c(1.0, 1.4, 1.8, 2.2)) + scale_x_continuous(name=("Precipitation JJA 5-yr\nmean anomaly (mm/day)"), breaks=c(-0.5, 0, 0.5))+ theme(legend.title=element_blank(), legend.key=element_rect(fill="white"), legend.key.size = unit(0.35, "cm"), legend.position = c(0.5,0.9),plot.margin=unit(c(0,0,0,0), "cm")) +scale_fill_manual( name=NULL, breaks=c("1", "3"), label=c("Wet 5-yr period", "Dry 5-yr period"), values=c(col4)) 
...
variNULL <- subset(F33, select=c("fire", "insect", "disease", "animal", "weather", "Drysummer", "Wetsummer", "Dryperiod", "Wetperiod", "unknowndamage"))
...
TPAadj<- ((CONDTPA-NULLTPA)/NULLTPA)*100
...
NullVarRatiod <- mean(variNULL[[v2]]) #/(sum(F33$mortality2/6.018))  # mean(variNULL[[v2]])# 
CondVarRatiod <- mean(variCOND[[v2]]) #/(sum(f22$mortality2/6.018))  # mean(variCOND[[v2]])#
...
NullVarRatiodex.unknown <- mean(variNULL[[v2]][variNULL$unknowndamage==0]) #/(sum(F33$mortality2/6.018))  # mean(variNULL[[v2]])# 
CondVarRatiodex.unknown <- mean(variCOND[[v2]][variCOND$unknowndamage==0]) #/(sum(f22$mortality2/6.018))  # mean(variCOND[[v2]])#
...
f34 <- c(vari2[v2],Clim, round(n,0), round(n2,0), round(CondVarRatiod,3), round(NullVarRatiod,4), round(rateRatiod,4), round(rateRatiodex.unknown,2), round(rateRatiod.CIupper2,2), round(rateRatiod.CIlower2,2), sig) #, round(Vgrow2,2), round(Vgrow,2), error2)
F5b <- rbind(F5b, f34)
print(c(v2, v, c))
}
}
...
setnames(F6b, c("Disturbance type", "Climate condition", "n","COND n", "%CondVarRatiod", "%NullVarRatiod", "%rateRatiod","%rateratiodex.unknown", "CI.lower","CI.upper", "p < 0.05") )#, "Vgrow2","Vdead", "error2"))
print((F6b))
#write.csv((F6b))
...
ff2<-subset(F2, startsumTPA>20 & weather>0)
mean(ff2$startsumTPA)
mean(ff2$weather)
2/141*10045
...
time<-250 #years forward modeling
...
#{arrows(x1,y1, x2, y2 ,col=("salmon"), length=0.07, angle=25,lwd=2)	} #denote 100 years of growth with red vectors
{
	...
	arrows(x1,y1, x2, y2 ,col=(col5[c]), length=0.07, angle=25,lwd=1.7)
}
...
#{arrows(x1,y1, x2, y2 ,col=("salmon"), length=0.07, angle=25,lwd=2)	} #denote 100 years of growth with red vectors
{
	...
	#arrows(x1,y1, x2, y2 ,col=(col5[c]), length=0.07, angle=25,lwd=1.7)
		...
		points(x2,y2, col="white", pch=(c-1), cex=0.85)
		points(x2,y2, col="black", pch=(c-1), cex=0.8)
 	points(x2,y2, col="black", pch=(c-1), cex=0.35)
	points(x2,y2, col=col5[c], pch=c-1, cex=0.65)
		} #denote 100 years of growth with red vectors

if(i== 30 ) #time/5)
{
	points(x2,y2, col="white", pch=(c-1), cex=1.5)
 	points(x2,y2, col="black", pch=(c-1), cex=1.45)
 	points(x2,y2, col="black", pch=(c-1), cex=1)
	points(x2,y2, col=col5[c], pch=c-1, cex=0.1.25)
	 }
